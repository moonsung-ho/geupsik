...
if (isIos() && !isInStandaloneMode() && localStorage.getItem("homescreenbanner") !== "true") {
  ...
  <div  style="margin: 200 auto;text-align:center;overflow:hidden;border-radius:0px;background:#ffffff;border:0px solid #ff0000;padding:8px;max-width:calc(100% - 16px);width:700px">
    <div  style="display:inline-block;position:relative;vertical-align: middle;padding:3px;font-size:45px;color:#000000;font-weight:normal">앱을 홈 화면에 <br>추가하세요!</div>
    <div class="descAnim765"  style="display:inline-block;position:relative;vertical-align: middle;padding:3px;font-size:14px;color:#000000;font-weight:bold">공유 버튼을 누르고 홈 화면에 추가 버튼을 누르세요!</div>
  </div>`;
}
